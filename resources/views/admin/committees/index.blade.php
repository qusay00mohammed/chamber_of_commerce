...
<script>
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/committees/' + id, ref);
        }
    </script>
@endpush
...
@section('content')
    ...
    <div class="card p-3">
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a href="{{ route('committees.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title=""
                data-bs-original-title="إضافة لجان">
