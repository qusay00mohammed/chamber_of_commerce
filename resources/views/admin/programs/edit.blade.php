...
@push('javascript')
    ...
    <script>
        ...
        function performStore() {
            ...
            updateURL = "{{ route('programs.update', [$program->id]) }}";
            redirectUrl = "{{ route('programs.index') }}";
                    ...
                    <form id="create_form" onsubmit="event.preventDefault(); performStore();">
                        ...
                        <div class="row row-sm">
                            ...
                            <input class="form-control mb-2" name="title" required type="text"
                                placeholder="عنوان البرنامج" value="{{ $program->title }}">

                            <label for="" class="mb-3">وصف البرنامج</label>
                            <textarea id="editor" name="description" class="tox-target" placeholder="تفاصيل البرنامج">{{ $program->description }}</textarea>
                        </div>
