...
<script>
    ...
    <script>
        ...
        function performUpdate() {
            ...
            updateURL = "{{ route('images.update', [$news->id]) }}";
            redirectUrl = "{{ route('images.index') }}";
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الغرفة التجارية
        ...
        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
        <small class="text-muted fs-7 fw-bold my-1 ms-1">تعديل ألبوم الصور</small>
    </h1>
@endsection
                ...
                <div class="card-body">
                    <form id="create_form" onsubmit="event.preventDefault(); performUpdate();">
                        ...
                        <div class="row row-sm">
                            ...
                            <label for="" class="mb-3">عنوان ألبوم الصور</label>
                        ...
                        <div class="row row-sm">
                            <div class="col-lg-12">
                                <div class="form-group mg-b-0" style="position: relative">
                                    ...
                                    <a href="{{ asset("storage/files/images/$news->basicFile") }}" data-fancybox >
                            ...
                            @if ($part2[1] == 'mp4')
                                ...
                                <div class="image-container">
                                    <video height="100px" width="100px" controls>
                                        <source src="{{ asset("storage/files/images/$file->filename") }}" type="video/mp4">
                            ...
                            @else
                                ...
                                <div class="image-container">
                                    <img height="100px" width="100px" class="mt-2"
                                        src="{{ asset("storage/files/images/$file->filename") }}">
                                    <a class="delete-button" onclick="deleteImage({{ $file->id }}, this)">x</a>
                                </div>
