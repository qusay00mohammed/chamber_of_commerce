...
@section('title', 'اخبار معبر كرم ابو سالم')
...
<script>
    ...
    <script>
        var table = $('#kt_datatable_example_5').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ Route('keremShalomCrossing.index') }}",
                data: function(d) {
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/keremShalomCrossing/' + id, ref);
        }
    </script>
@endpush
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الغرفة التجارية
        ...
        <!--end::Separator-->
        <!--begin::Description-->
        <small class="text-muted fs-7 fw-bold my-1 ms-1">اخبار معبر كرم ابو سالم</small>
        <!--end::Description-->
    </h1>
@endsection
...
@section('content')
    ...
    <div class="card p-3">
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            ...
            <a href="{{ route('archive_keremShalom') }}" class="btn btn-success" data-bs-toggle="tooltip" title=""
                data-bs-original-title="الارشيف" style="margin-left: 15px">
            <i class="fa-solid fa-inbox"></i>
            <!--end::Svg Icon-->الارشيف</a>

            <a href="{{ route('keremShalomCrossing.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title=""
