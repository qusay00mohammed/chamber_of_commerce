...
<script>
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/erezCrossing/' + id, ref);
        }
    </script>
@endpush
...
@section('content')
    ...
    <div class="card p-3">
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            ...
            <a href="{{ route('archive_erez') }}" class="btn btn-success" data-bs-toggle="tooltip" title=""
                data-bs-original-title="الارشيف" style="margin-left: 15px">
            <i class="fa-solid fa-inbox"></i>
            <!--end::Svg Icon-->الارشيف</a>


            <a href="{{ route('erezCrossing.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title=""
