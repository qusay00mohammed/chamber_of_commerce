...
<script>
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/rafahCrossing/' + id, ref);
        }
    </script>
@endpush
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الغرفة التجارية
        ...
        <!--end::Separator-->
        <!--begin::Description-->
        <small class="text-muted fs-7 fw-bold my-1 ms-1">اخبار معبر رفح</small>
        <!--end::Description-->
    </h1>
@endsection
...
@section('content')
    ...
    <div class="card p-3">
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            ...
            <a href="{{ route('archive_rafah') }}" class="btn btn-success" data-bs-toggle="tooltip" title=""
            ...
            <a href="{{ route('rafahCrossing.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title=""
