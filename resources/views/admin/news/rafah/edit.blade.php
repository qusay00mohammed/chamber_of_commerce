...
<script>
    ...
    <script>
        ...
        function performUpdate() {
            ...
            updateURL = "{{ route('rafahCrossing.update', [$news->id]) }}";
            redirectUrl = "{{ route('rafahCrossing.index') }}";
        ...
        function deleteImage(id, ref) {
            destroyImage('/admin/image/delete/' + id, ref, 'rafah');
        }
                    ...
                    <form id="create_form" onsubmit="event.preventDefault(); performUpdate();">
                        ...
                        <div class="row row-sm">
                            <div class="col-lg-12">
                                <div class="form-group mg-b-0" style="position: relative">
                                    ...
                                    <a href="{{ asset("storage/$news->basicFile") }}" data-fancybox >
                        ...
                        <div class="image-container">
                            <img height="100px" width="100px" class="mt-2"
                                src="{{ asset("storage/$file->filename") }}">
