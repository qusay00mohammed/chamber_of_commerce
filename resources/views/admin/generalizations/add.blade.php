...
@push('javascript')
    ...
    <script>
        ...
        function performStore() {
            ...
            store('/admin/generalizations', data);
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الغرفة التجارية
        ...
        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
        <small class="text-muted fs-7 fw-bold my-1 ms-1">إضافة تعميم</small>
    </h1>
@endsection
                ...
                <div class="card-body">
                    <form id="create_form" onsubmit="event.preventDefault(); performStore();">
                        ...
                        <div class="row row-sm">
                            ...
                            <input class="form-control mb-2" name="title" required type="text" placeholder="عنوان التعميم">

                            <label for="" class="mb-3">وصف التعميم</label>
                            <textarea id="editor" name="description" class="tox-target" placeholder="تفاصيل التعميم"></textarea>
                        </div>
