...
<script>
    ...
    <script>
        var table = $('#kt_datatable_example_5').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ Route('generalizations.index') }}",
            },
            columns: [{
                    data: 'id',
                    name: 'id'
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/generalizations/' + id, ref);
        }
    </script>
@endpush
...
@section('content')
    ...
    <div class="card p-3">
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a href="{{ route('generalizations.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title=""
                data-bs-original-title="إضافة تعميم">
