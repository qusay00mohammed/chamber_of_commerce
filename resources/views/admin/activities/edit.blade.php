...
<script>
    ...
    <script>
        ...
        function performUpdate() {
            ...
            updateURL = "{{ route('activities.update', [$news->id]) }}";
        ...
        function deleteImage(id, ref) {
            destroyImage('/admin/image/delete/' + id, ref, 'activity');
        }
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الغرفة التجارية
        ...
        <small class="text-muted fs-7 fw-bold my-1 ms-1">الفعاليات</small>

        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
        <small class="text-muted fs-7 fw-bold my-1 ms-1">تعديل فعالية</small>
    </h1>
@endsection
                ...
                <div class="card-body">
                    <form id="create_form" onsubmit="event.preventDefault(); performUpdate();">
                        ...
                        <div class="row row-sm">
                            ...
                            <input class="form-control mb-2" name="title" required type="text" placeholder="عنوان الفعالية" value="{{ $news->title }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <label for="" class="mb-3">حالة النشاط</label>
                        ...
                        <div class="row row-sm">
                            <div class="col-lg-12">
                                <div class="form-group mg-b-0" style="position: relative">
                                    ...
                                    <a href="{{ asset("storage/files/activities/$news->basicFile") }}" data-fancybox >
                        ...
                        @foreach ($news->files as $file)
                            ...
                            @if ($part2[1] == 'mp4')
                                ...
                                <div class="image-container">
                                    <video height="100px" width="100px" controls>
                                        <source src="{{ asset("storage/files/activities/$file->filename") }}" type="video/mp4">
                            ...
                            @else
                                ...
                                <div class="image-container">
                                    <img height="100px" width="100px" class="mt-2"
                                        src="{{ asset("storage/files/activities/$file->filename") }}">
                                    <a class="delete-button" onclick="deleteImage({{ $file->id }}, this)">x</a>
                                </div>
