...
<script>
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/tradeDelegations/' + id, ref);
        }
        ...
        function performStore() {
            ...
            store('/admin/tradeDelegations', data);
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#kt_datatable_example_5').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ Route('tradeDelegations.index') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">الغرفة التجارية
        ...
        <!--end::Separator-->
        <!--begin::Description-->
        <small class="text-muted fs-7 fw-bold my-1 ms-1">الوفود التجارية</small>
        <!--end::Description-->
    </h1>
@endsection
...
@include('layouts.alert')
    <div class="card p-3">
        ...
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a data-bs-toggle="modal" data-bs-target="#kt_modal_1" class="btn btn-primary" title=""
                data-bs-original-title="إضافة وفد تجاري">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">إضافة وفد تجاري</h5>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_2">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">تعديل وفد تجاري</h5>
                ...
                <form action="{{ route('tradeDelegations.update', 'test') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf
                        @method("PUT")
                        <div class="form-group">
