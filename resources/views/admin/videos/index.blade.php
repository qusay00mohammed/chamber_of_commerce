...
<script>
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/videos/' + id, ref);
        }
    </script>
@endpush
...
@section('content')
                    ...
                    <div class="" id="collapseExample">
                        <div class="card card-body">
                            ...
                            <div class="row" id="reset_form">
                                <div class="col-md-4">
                                    <label for="" class="mb-3">عنوان الفيديو</label>
    ...
    <div class="card p-3">
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a href="{{ route('videos.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title=""
                data-bs-original-title="إضافة ألبوم فيديو">
